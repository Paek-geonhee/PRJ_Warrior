...
void AWarriorProjectileBase::HandleApplyProjectileDamage(APawn* HitPawn, const FGameplayEventData& Payload)
{
	...
	const bool bWasApplied = UWarriorFunctionLibrary::ApplyGameplayEffectSpecHandleToTargetActor(GetInstigator(), HitPawn, ProjectileDamageEffectSpecHandle);
