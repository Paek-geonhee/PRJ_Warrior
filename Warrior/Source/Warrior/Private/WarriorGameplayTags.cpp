...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Abilityt_Unequip_Axe, "Player.Ability.Unequip.Axe");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_MustBeHeld, "Player.MustBeHeld");
	UE_DEFINE_GAMEPLAY_TAG(Player_MustBeHeld_Block, "Player.MustBeHeld.Block");
